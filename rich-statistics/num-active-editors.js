...
table.addRow([ 'Number of users active (1+ action) in the last 30 days', orz(userswithcount[1]) + '<ref>Users active in the last 30 days according to [[mw:API:Allusers]] with auactiveusers=1, which is different from figure on [[Special:Statistics]] ([[phab:T261290]]). Users with recentchanges value equal to 0 ([[phab:T261282]]) are not counted</ref>' ]);
...
table.addRow([ 'Users with 100+ actions in the last 30 days', orz(userswithcount[500]) ]);
table.addRow([ 'Users with 100+ actions in the last 30 days', orz(userswithcount[1000]) ]);
